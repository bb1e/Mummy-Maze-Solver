...
public class MainFrame extends JFrame {
    ...
    private MummyMazeAgent agent = new MummyMazeAgent(new MummyMazeState(initialMatrix, 0, 0, 0, 0, new LinkedList<>(), new LinkedList<>()));
    ...
    private void jbInit() throws Exception {
        ...
        areaJogo = new GameArea();
        puzzlePanel.add(areaJogo);
    ...
    public void buttonInitialState_ActionPerformed(ActionEvent e) {
        ...
        try {
            if (fc.showOpenDialog(this) == JFileChooser.APPROVE_OPTION) {
                areaJogo.setState(agent.readInitialStateFromFile(fc.getSelectedFile())); //areaJogo
    ...
    public void comboBoxSearchMethods_ActionPerformed(ActionEvent e) {
        ...
        areaJogo.setState(agent.resetEnvironment());
        buttonSolve.setEnabled(true);
        buttonShowSolution.setEnabled(false);
        buttonReset.setEnabled(false);
        textArea.setText("");
